...
import com.example.finalpam.ui.viewmodel.jenis.DetailJnsUiState
...
fun DetailJenisView(
    ...
    detailjenisViewModel: DetailJenisViewModel = viewModel(factory = PenyediaViewModel.Factory)
){
    ...
    Scaffold(
        ...
        floatingActionButton = {
            FloatingActionButton(
                onClick = {
                    val id_jenis = (detailjenisViewModel.detailJnsUiState as? DetailJnsUiState.Success)?.jenis?.id_jenis
                    if (id_jenis != null) onEditClick(id_jenis)
                },
        ...
        Box(
            ...
            DetailStatus(
                jnsUiState = detailjenisViewModel.detailJnsUiState,
                retryAction = { detailjenisViewModel.getJnsById() },
                modifier = Modifier
                    .fillMaxWidth()
...
fun DetailCard(
    ...
    Card(
        ...
        Column(
            ...
            ComponentDetailJns(judul = "Id_Jenis", isinya = jenis.id_jenis)
            Spacer(modifier = Modifier.height(8.dp))
            ComponentDetailJns(judul = "Nama_Jenis", isinya = jenis.nama_jenis)
            Spacer(modifier = Modifier.height(8.dp))
            ComponentDetailJns(judul = "Deskripsi_Jenis", isinya = jenis.deskripsi_jenis)
            Spacer(modifier = Modifier.height(8.dp))
        }
    }
}
