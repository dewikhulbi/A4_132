...
fun  HomeManajerScreen (
    ...
    Scaffold (
        ...
        HomeStatus (
            homeUiState =  viewModel .mnjrUIState,
            retryAction =  {  viewModel . getMnjr ()  } ,  modifier =  Modifier . padding ( innerPadding ),
            onDetailClick =  onDetailClick ,  onDeleteClick =  {
                viewModel . deleteMnjr ( it .id_manajer   )
                viewModel . getMnjr ()
            }
        )
        ...
        is  HomeManajerUiState. Success  ->
            if  ( homeUiState .manajer. isEmpty ()){
                ...
                MnjrLayout (
                    ...
                    manajer =  homeUiState .manajer,  modifier =  modifier . fillMaxWidth (),
                    onDetailClick =  {
